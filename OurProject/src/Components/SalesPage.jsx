...
//   const initialQuantity = Number(realData?.inpValue) || 0; // initial stock
//   const currentQuantity = Number(realData?.productQuantity) || 0; // stock left
//   const sellingPrice = Number(realData?.productSellingPrice) || 0;
//   const actualPrice = Number(realData?.productActualPrice) || 0;

//   // 🟢 Calculate items sold (no negatives)
//   const itemsSold = Math.max(initialQuantity - currentQuantity, 0);

//   // 🟢 Sales (Revenue)
//   const currentSales = itemsSold * sellingPrice;

//   // 🟢 Total Amount Spent (investment cost)
