...
// //     prev.map((p) =>
// //       p._id === item._id
// //         ? { ...p, productQuantity: p.productQuantity + 1, inpValue: p.inpValue + 1 } // 👈 also update inpValue
// //         : p
// //     )
// //   );
...
// //         counter: 1,
// //         quantity: item.productQuantity + 1,
// //         inpValue: item.inpValue + 1 // 👈 send updated inpValue
// //       },
// //       { headers: { "Content-Type": "application/json" } }
// //     );
// //   } catch (err) {
...
// //                   {/* Sales Info */}
// //                   <div>
// //                     <SalesPage data={item,allProducts} />
// //                   </div>
...
//       .catch((err) => {
//         console.error("Error increasing:", err);
//         fetchProducts(); // fallback if failed
//       });
//   };
...
//     } catch (err) {
//       console.error("Error deleting:", err);
//       fetchProducts(); // fallback restore
//     }
//   };
